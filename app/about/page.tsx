            ...
            <section className="bg-primary-900 py-20 text-center">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-primary-200 text-lg max-w-2xl mx-auto">
                        Discover the heritage, mission, and vision that drive Al Diyar Al Arabia National SPC to be Oman&apos;s premier food commodities trading partner.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <div className="space-y-4 text-gray-600 leading-relaxed text-lg">
                                <p>
                                    Founded over two decades ago, Al Diyar Al Arabia National SPC has grown from a humble local enterprise into a cornerstone of Oman&apos;s agricultural and food commodities sector. Our journey is paved with unwavering dedication, family values, and a profound respect for the communities we serve.
                                </p>
                                <p>
                    ...
                    <div className="max-w-4xl mx-auto space-y-8">
                        <div className="flex flex-col md:flex-row gap-6 border-l-2 border-gold-200 pl-6 relative">
                            ...
                            <div className="md:w-3/4 text-gray-600">
                                ...
                                The inception of Al Diyar Al Arabia National SPC as a small local trading outfit in Muscat, specializing initially in rice imports.
                            </div>
                        </div>
