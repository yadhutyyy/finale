            ...
            <section className="bg-primary-900 py-20 text-center">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-primary-200 text-lg max-w-2xl mx-auto">
                        Meet the visionary leader shaping the legacy of Al Diyar Al Arabia National SPC.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                        <div className="lg:col-span-4">
                            <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border-4 border-white bg-primary-950 flex flex-col items-center justify-center p-6 text-center select-none">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 border-t border-primary-800/80 pt-4 text-left relative z-10">
                                    <div className="text-xs text-primary-300 font-medium">Al Diyar Al Arabia National SPC</div>
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
                                <p>
                                    A seasoned entrepreneur and an astoundingly meticulous strategist, Hemanth Bhaskaran established Al Diyar Al Arabia National SPC with a singular vision: to revolutionize the standard of commodities trading in the Sultanate of Oman.
                                </p>
                                <p>
